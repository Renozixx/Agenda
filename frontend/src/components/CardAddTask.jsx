...
const CardAddTask = () => {
  ...
  return (
    <>
      <div onClick={() => setHidden(false)} className="flex flex-wrap justify-center items-center gap-1 w-80 min-h-40 h-max p-2 text-white bg-slate-800 bg-opacity-50 rounded-md cursor-pointer">
